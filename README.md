...
```bash
curl -L https://github.com/sangkan-dev/temu/releases/download/v1.1.1/temu-linux-x86_64-static \
...
```bash
curl -L https://github.com/sangkan-dev/temu/releases/download/v1.1.1/SHA256SUMS \
  -o SHA256SUMS
